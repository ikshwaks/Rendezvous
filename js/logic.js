...
var p1v=" ";
var latf,lngf;
var totaldist=0;//For total distance
...
function showPlaces(text) {
	...
	for(var i=0;text.getElementsByTagName("name")[i];i++)
	{
		...
		//following if conditions are for refining places not to include unnecessary places as they can't at these kind of places
...
function placeSearch() {
	...
	var url = 'https://maps.googleapis.com/maps/api/place/nearbysearch/xml?location='+latf+','+lngf+'&radius='+rad+'&types='+option+'&key=placeKey';
...
function startSearch() {
	...
	var p1=document.getElementById("place1").value;//Get Place 1
	var p2=document.getElementById("place2").value;//Get Place 2

	var url="https://maps.googleapis.com/maps/api/directions/xml?origin="+p1+"&destination="+p2+"&key=AIzaSyBvQQv-YEYj_WSvmdYMMEUUOy4wt8ojSk4";
	var xyz2 = CORSCreation('GET', url);
